...
int main() {
    ...
    longitudBrazoLargo = (pesoBrazoLargo*longitudTotal)/ (pesoBrazoLargo+pesoBrazoCorto); 
    //en el peso de la multiplicacion se coloca el del brazon opuesto al que se desea obtener
    
    cout << "La longitud del brazo corto para equilibrio es: " << longitudBrazoLargo<< " metros" << endl;
